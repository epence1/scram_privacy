...
for n in n_vals:
    ...
    enp_prob_n = enp.prob_output_appearing(n)
    # print(enp_prob_0+enp_prob_n)
    enp_prob_0_n_for_n.append((enp_prob_0+enp_prob_n))
    enp_prob_0_for_n.append(enp_prob_0)
    enp_prob_n_for_n.append(enp_prob_n)

## Probability Mass of count=0,n various n
# plt.plot(n_vals, enp_prob_0_n_for_n, marker="o", label="eNP: Combined Probability Mass of Count=0 and Count=n")
# plt.plot(n_vals, enp_prob_0_for_n, marker="x", label="eNP: Probability Mass of Count=0")
# plt.plot(n_vals, enp_prob_n_for_n, marker="x", label="eNP: Probability Mass of Count=n")
# plt.title("Probability Mass of Counts for Various n: P="+str(PROB))
...
# plt.title("Minimum Achievable Epsilon for ANY p in 0.2 to 0.8")
# plt.xlabel("n")
# plt.ylabel("epsilon")
# plt.ylim(-1,5)
# plt.legend()
